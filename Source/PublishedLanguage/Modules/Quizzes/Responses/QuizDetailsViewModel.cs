...
public class QuizDetailsViewModel
{
    ...
    public required IReadOnlyCollection<QuizDetailsChoiceQuestionViewModel> SingleChoiceQuestions { get; set; }
    public required IReadOnlyCollection<QuizDetailsChoiceQuestionViewModel> MultipleChoiceQuestions { get; set; }
}