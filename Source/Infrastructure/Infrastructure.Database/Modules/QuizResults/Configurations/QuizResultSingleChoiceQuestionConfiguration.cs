...
public class QuizResultSingleChoiceQuestionConfiguration : BaseEntityConfiguration<QuizResultSingleChoiceQuestion>
{
    public override void Configure(EntityTypeBuilder<QuizResultSingleChoiceQuestion> builder)
    {
