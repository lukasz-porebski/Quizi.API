...
public class QuizMultipleChoiceQuestionConfiguration : BaseEntityConfiguration<QuizMultipleChoiceQuestion>
{
    public override void Configure(EntityTypeBuilder<QuizMultipleChoiceQuestion> builder)
    {
