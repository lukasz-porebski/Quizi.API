...
namespace Infrastructure.Database.Migrations
{
    ...
    [Migration("20260215095453_AddPermissions")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Modules.Permissions.Models.Permission", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(36)
                        .HasColumnType("character varying(36)")
            ...
            modelBuilder.Entity("Domain.Modules.Roles.Models.Role", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(36)
                        .HasColumnType("character varying(36)")
            ...
            modelBuilder.Entity("Domain.Modules.Roles.Models.RolePermission", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(36)
                        .HasColumnType("character varying(36)")
            ...
            modelBuilder.Entity("Domain.Modules.Users.Models.UserRole", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(36)
                        .HasColumnType("character varying(36)")
            ...
            modelBuilder.Entity("Domain.Modules.Roles.Models.RolePermission", b =>
                {
                    b.HasOne("Domain.Modules.Roles.Models.Role", null)
                        .WithMany("Permissions")
                        .HasForeignKey("Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_rolepermissions_roles_id");

                    b.HasOne("Domain.Modules.Permissions.Models.Permission", null)
                        .WithMany()
